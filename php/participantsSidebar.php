...
if(isset($_GET["cID"]{
	...
	$sql = "SELECT uID, f_name, l_name FROM (participates NATURAL JOIN user) WHERE (cID = '$cID')";
	echo "<div class='sidebarContent'>";
		if($result = $connection->query($sql)){
			...
			while($participants = $result->fetch_array(MYSQLI_ASSOC)){
				...
				echo "<div class='profileLink hvr-fade-green'>".$participants["f_name"]." ".$participants["l_name"]."</div>";
				echo "</a></br>";		
			}	
		}
		else{
